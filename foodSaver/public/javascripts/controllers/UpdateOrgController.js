angular.module('foodsaver').controller('updateOrgController', [ '$scope', '$http', 'FsConfigService', 'FsLoggerService', 'orgCrudService', function ( $scope, $http, fsConfigs, fsLogger, orgCrudService ) {
